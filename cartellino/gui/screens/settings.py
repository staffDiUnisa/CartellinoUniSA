...
class SettingsScreen(QWidget):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.btn_sfoglia_data_folder.setObjectName("btn-sfoglia-data-folder")
        ...
        self.btn_sfoglia_output_folder.setObjectName("btn-sfoglia-output-folder")
        ...
        self.btn_date_escluse.setObjectName("btn-date-escluse")
        ...
        self.btn_sfoglia_template_riposo.setObjectName("btn-sfoglia-template-riposo")
        ...
        self.btn_modifica_cred.setObjectName("btn-modifica-cred")
        self.btn_modifica_cred.clicked.connect(self._apri_modifica_credenziali)
        self.btn_rimuovi_cred = QPushButton("🗑️ Rimuovi credenziali")
        self.btn_rimuovi_cred.setObjectName("btn-rimuovi-cred")
