...
If your issue isn't listed above, or you think you've found a bug, open an
[issue on GitHub](https://github.com/staffDiUnisa/CartellinoUniSA/issues/new) — it's the official
channel for bug reports. For a useful report, please include when possible: the app version and
